...
package com.robotca.sjControlApp.Views;
...
import com.robotca.sjControlApp.ControlApp;
import com.robotca.sjControlApp.Core.ControlMode;
import com.robotca.sjControlApp.R;
...
//        enableTiltCheckBox(accelerometer != null);
    ...
    private void onContactMove(float x, float y) {
        ...
        Log.i(TAG, String.format("joystickRadius is %f", joystickRadius));
        Log.i(TAG, String.format("onContactMove: thumbDivetX is %f, thumbDivetY is %f", thumbDivetX, thumbDivetY));
        ...
        if (holonomic) {
            ...
            Log.i(TAG, String.format("onContactMove: is Holonomic, to publish %f, %f, %f", normalizedMagnitude * Math.cos(contactTheta * Math.PI / 180.0),
